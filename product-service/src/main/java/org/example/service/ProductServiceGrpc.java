...
public final class ProductServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ProductServiceProto.ProductRequest,
      ProductServiceProto.ProductResponse> getGetProductByIdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getProductById",
      requestType = ProductServiceProto.ProductRequest.class,
      responseType = ProductServiceProto.ProductResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ProductServiceProto.ProductRequest,
      ProductServiceProto.ProductResponse> getGetProductByIdMethod() {
    io.grpc.MethodDescriptor<ProductServiceProto.ProductRequest, ProductServiceProto.ProductResponse> getGetProductByIdMethod;
      ...
      synchronized (ProductServiceGrpc.class) {
        if ((getGetProductByIdMethod = ProductServiceGrpc.getGetProductByIdMethod) == null) {
          ProductServiceGrpc.getGetProductByIdMethod = getGetProductByIdMethod =
              io.grpc.MethodDescriptor.<ProductServiceProto.ProductRequest, ProductServiceProto.ProductResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getProductById"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ProductServiceProto.ProductRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ProductServiceProto.ProductResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getProductById(ProductServiceProto.ProductRequest request,
                                io.grpc.stub.StreamObserver<ProductServiceProto.ProductResponse> responseObserver) {
  ...
  public static final class ProductServiceStub
    ...
    /**
     */
    public void getProductById(ProductServiceProto.ProductRequest request,
                               io.grpc.stub.StreamObserver<ProductServiceProto.ProductResponse> responseObserver) {
  ...
  public static final class ProductServiceBlockingStub
    ...
    /**
     */
    public ProductServiceProto.ProductResponse getProductById(ProductServiceProto.ProductRequest request) {
  ...
  public static final class ProductServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ProductServiceProto.ProductResponse> getProductById(
        ProductServiceProto.ProductRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PRODUCT_BY_ID:
          serviceImpl.getProductById((ProductServiceProto.ProductRequest) request,
              (io.grpc.stub.StreamObserver<ProductServiceProto.ProductResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ProductServiceProto.ProductRequest,
              ProductServiceProto.ProductResponse>(
